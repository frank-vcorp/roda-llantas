                ...
                >
                  ...
                  <div className="p-4 flex flex-col h-full">
                    ...
                    <div className="flex justify-between items-start gap-3 mb-3">
                      ...
                      {/* Stock Badge */}
                      <div
                        className={`px-2.5 py-1 rounded-lg text-xs font-bold whitespace-nowrap ${hasStock ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}
                      >
                    ...
                    <div className="bg-slate-50 rounded-lg p-3 mb-3 border border-slate-100">
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        ...
                        {/* WAREHOUSE BREAKDOWN (IMPL-MULTI-WAREHOUSE-MOBILE) */}
                    ...
                    <div className="flex justify-between items-center gap-3 mt-auto pt-3 border-t border-slate-100">
                      ...
                      <Button
                        ...
                        disabled={!hasStock}
                        className={`rounded-lg h-10 px-4 font-semibold transition-all gap-2 ${hasStock ? "bg-emerald-600 hover:bg-emerald-700 text-white" : "bg-slate-200 text-slate-400 cursor-not-allowed"}`}
                      >
